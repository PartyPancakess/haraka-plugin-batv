...
beforeEach(function (done) {
  this.plugin = new fixtures.plugin('batv')
  done()  // if a test hangs, assure you called done()
})

describe('batv', function () {
...
describe('load_batv_ini', function () {
  it('loads batv.ini from config/batv.ini', function (done) {
    this.plugin.load_batv_ini()
